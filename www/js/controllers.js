...
.controller('singleVehiculoCtrl', function($scope, $ionicModal, $stateParams, $api, $state, $ionicSideMenuDelegate, $timeout) {
  ...
  $scope.modelosPrueba = [{nombre:"Agya"}, {nombre:"Etios"}, {nombre:"Yaris"}, {nombre:"Corolla"}, {nombre:"Rush"}, {nombre:"Avanza"}, {nombre:"Rav4"}, {nombre:"Fortuner"}, {nombre:"Land Cruiser Prado"}, {nombre:"Land Cruiser Station Wagon"}, {nombre:"Hilux Cabina Sencilla 4x2"}, {nombre:"Hilux Doble Cabina 4x2"}, {nombre:"Hilux Doble Cabina 4x2 Prerruner"}, {nombre:"Hilux Cabina Sencilla 4x4"}, {nombre:"Hilux Extra Cabina 4x4"}, {nombre:"Hilux Doble Cabina 4x4"}, {nombre:"Land Cruise Pick Up"}, {nombre:"GT 86"}, {nombre:"Hiace Panel"}, {nombre:"Hiace Pasajeros Techo Bajo"}, {nombre:"Hiace Pasajeros Techo Alto"}, {nombre:"Coaster"}];  
